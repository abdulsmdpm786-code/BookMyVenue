...
const payload = {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      await AXIOS_API.post(`/api/v2/message/post`, {});
    } catch (error) {}
      ...
      <main className="max-w-7xl mx-auto px-6 md:px-12 mt-12 relative z-10">
        ...
        >
          ...
          <p className="text-sm md:text-base text-slate-500 font-medium mt-3 max-w-xl mx-auto leading-relaxed">
            Have questions about our premium spaces, hosts, or booking process?
          ...
          >
            <div className="bg-white rounded-3xl border border-slate-200/80 p-6 md:p-8 shadow-[0_10px_30px_-10px_rgba(0,0,0,0.05)] space-y-6">
              ...
              <p className="text-xs md:text-sm text-slate-500 font-medium leading-relaxed">
                Reach out to us directly or stop by our Oakland headquarters. We
                try to respond to all inquiries within 2 hours.
              </p>
              ...
              <div>
                <span className="block text-[10px] text-slate-400 font-bold uppercase tracking-wider mb-3">
                  Connect on Socials
                </span>
                <div className="flex gap-3">
                  <a
                    href="#"
                    className="w-10 h-10 rounded-full border border-slate-200 flex items-center justify-center text-slate-500 hover:text-ticket-orange hover:border-ticket-orange/40 hover:bg-ticket-orange/5 transition-all duration-200 active:scale-95"
                    title="Twitter / X"
                  >
                    <svg
              ...
              {status === "success" ? (
                <div className="text-center py-10 px-4 space-y-4 animate-fade-in">
                  ...
                  <p className="text-sm text-slate-500 font-medium max-w-sm mx-auto leading-relaxed">
                    Thank you for reaching out to TicketSeats. We have received
                    your inquiry and a ticket has been created. A support
                    specialist will follow up with you at your email address
                    shortly.
                  </p>
                  <button
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  <h3 className="text-xl font-bold text-slate-850 tracking-tight pl-0.5">
                    Send a Message
                  </h3>

...
function EditModal({ venue, error, onClose, isLoading, onSubmit }) {
          ...
          >
            <div className="absolute top-6 right-8 flex  items-center gap-3">
              <h1 className="text-ticket-orange text-xs">
                📝 Edit image <span className="text-red-700 text-lg">*</span>
              </h1>
            ...
            <div className="flex justify-between items-start mt-4 mb-10 pr-16">
              <div className="text-xs font-medium text-gray-400">
                ID:{" "}
                <span className="text-gray-300">{formData.organiZerId}</span>
              </div>

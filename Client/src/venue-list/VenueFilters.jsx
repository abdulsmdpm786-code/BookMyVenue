      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-4">
        ...
        <div className="relative md:col-span-3 animate-fade-in-stagger delay-300">
          ...
          >
            ...
            <option value="250" className="bg-[#FAF9F6] text-slate-800">250+ guests</option>
          </select>
        </div>
      ...
      <div className="flex flex-wrap gap-2 pt-2 border-t border-slate-100 animate-fade-in-stagger delay-600">
        {categories.map((category) => (
          <button 
            ...
            className={`px-5 py-2.5 rounded-xl text-xs font-bold uppercase tracking-wider transition-all duration-300 active:scale-95 ${

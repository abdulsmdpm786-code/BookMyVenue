...
function RegisterModal({ onClose, bookingData }) {
  ...
  return (
    <div>
      ...
      p-4"
      >
        <div className="relative w-full max-w-[500px] bg-[#FAF9F6] rounded-[2rem] p-8 shadow-2xl animate-modal-fade">
          <button
            onClick={() => onClose()}
            className="absolute top-6 right-6 flex items-center justify-center w-10 h-10 bg-white border border-gray-200 rounded-full text-gray-500 hover:text-gray-800 hover:bg-gray-50 transition-colors focus:outline-none focus:ring-2 focus:ring-slate-800"
          >
          ...
          <form className="space-y-5">
            ...
            <div className="flex gap-4 pt-4">
              <button
                onClick={() => onClose()}
                type="button"
                className="flex-1 bg-transparent border border-gray-200 text-slate-600 font-bold py-3.5 rounded-2xl hover:bg-gray-50 hover:text-slate-900 focus:outline-none focus:ring-2 focus:ring-slate-800 transition-all"
              >
                Cancel
              </button>
              <button
                type="submit"
                className="flex-1 bg-[#111827] text-white font-bold py-3.5 rounded-2xl shadow-lg hover:bg-[#1f2937] hover:shadow-xl focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-slate-900 transition-all"
              >
                Confirm Tour
              </button>
            </div>

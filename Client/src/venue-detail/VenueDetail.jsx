...
export function VenueDetail() {
  ...
  if (!venue) {
    return (
      <div className="min-h-screen bg-gradient-to-b from-[#D4CEB8] via-[#F4F1E6] to-[#FAF9F6] font-sans
       flex flex-col items-center justify-center p-6 text-center venue-detail-page">
        <div className="bg-[#F7F5EE] border border-slate-200 rounded-[2rem] p-8 max-w-sm w-full shadow-lg">
          <h3 className="text-xl font-bold text-slate-800 mb-2">Venue Not Found</h3>
          <p className="text-xs text-slate-500 mb-6">The listing you are trying to view does not exist or has been removed.</p>
          <Link 
            to="/venues"
  ...
  return (
    <div className="min-h-screen w-full font-sans bg-gradient-to-b from-[#D4CEB8] via-[#F4F1E6] to-[#FAF9F6]
